...
const PromoBannerVertical = ({ data }: Props) => {
  ...
  return (
    <div
      ...
      className="h-[40px] bg-red-600 w-screen relative text-white text-center font-medium"
    >
      <SwiperComponent
        ...
        {(item: { content: string }) => (
          <div className="flex justify-center items-center w-screen h-[40px]">
            <DynamicContent
              ...
              attrs={{
                className: 'px-1 text-sm lg:text-base leading-[14px]'
              }}
            />
          </div>
        )}
...
export default PromoBannerVertical
