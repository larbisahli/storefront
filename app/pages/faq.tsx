...
const FaqPage = ({ pageProps }: PageProps) => {
  ...
  return (
    <>
      <NextSeo
        ...
        canonical={`https://${host?.host}/faq`}
        openGraph={{
          url: `https://${host?.host}/faq`,
...
export const getServerSideProps: GetServerSideProps =
  wrapper.getServerSideProps((store) => async (context) => {
    ...
    try {
      ...
      // Page Query
      const page = await fetchStorePage(alias, storeLanguageId, 'faq', storeId)
